...
C+lsf_system
C
      subroutine lsf_system(interp,iocmd_results,def_sf,def_lsf,s)
...
C         Status variable - must be zero on entry - otherwise error
              integer             s
C
C     Combines all the logical sample files functions
C     in one place.
C
C-
C     ****************************************************************
...
C         Telescope code
              integer         tscope
C         Current and previous output device.
              integer         out, old_out
...
C
     ...
     *                             int_chop_record, .false., s )
        ...
        else if ( command .eq. exit_cmd) then
            continue
...
C     Reset initialisation flags for other subsystems.
      cal_init = .false.
      ion_init = .false.
      map_init = .false.
      rem_init = .false.
