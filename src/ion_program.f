...
C     Program to make ionospheric corrections, invoked from POSTMORTEM.
C
...
C     ******************************************************************
      ...
      parameter (process_name = 'ION', file_type = 'ION' )
...
C
  ...
  150     continue
              ...
              call ion_make_corr( file_name, s )
