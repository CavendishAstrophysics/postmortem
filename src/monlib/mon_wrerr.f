...
*+MON_WRERR
       ...
       subroutine mon_wrerr (status, text)
C
...
C
C  This routine sets up the error message file for the MONLIB library
...
C
       character   errfil*40
       parameter  (errfil = '/mrao/post/include/samplib_errors.inc')
C
