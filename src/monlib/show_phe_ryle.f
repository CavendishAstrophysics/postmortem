*+SHOW_PHE_RYLE
       ...
       subroutine show_phe_ryle (ifile, status)
c      ----------------------------------------
C
C  Displays Helium pressure readings by sample.
C
C  Given:
...
C
C  Subroutine to print out the Helium pressure readings recorded with
