...
C      ---------------------------------------------------------------
C
C  Plots ALC readings by aerial.
C
C  Given:
...
C      MAX_VALUE     real          maximum ALC value
...
C
C  Subroutine to produce plots of the ALC readings recorded with the
...
c
       ...
       call plot_setscale(.true., 0.0, max_value, status )
c
       do i=1,nae
         iae=ilist(i)
