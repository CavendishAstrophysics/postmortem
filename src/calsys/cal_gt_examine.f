...
C and save record for checking mode operation
       ...
       if (imode.ne.4 .and. imode.ne.5) then
 ...
 100     format(1x/1x,'Record  ','Source                      ',
     ...
     *                '----------------------------------------')
       ...
       do n=n1,n2
         if (imode.eq.5 .or. (gt_times(n).ge.date_low .and.
     *                        gt_times(n).le.date_high .and.
     *                        gt_times(n).ne.-1             ) ) then
           nwd = 1024
