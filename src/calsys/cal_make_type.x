...
C Open the LSF of the calibration and initialise
      call cal_open_lsf( 'RC', lsf_num, s )
...
C .. get visibilities and model visibilities for this sample
         call lsf_get_vis(  lsf_num, max_spac, vis_list,num_vis, s)
         call lsf_get_model(lsf_num, max_spac, mod_vis, num_vis, s)
...
C .. write sample redtape and data to the calibration file
     ...
     *                               cal_nvis, cal_list, gains_buff, s )
      ...
      if (buff_num .lt. num_buff) goto 100
